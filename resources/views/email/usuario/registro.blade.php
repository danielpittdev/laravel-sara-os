                        ...
                        <tr style="width:100%">
                           <td>
                              ...
                              <h1
                                 ...
                                 Bienvenido a <strong>{{ env('APP_NAME') }}</strong>, {{ $user->nombre }}
                              </h1>
                              <p
                              ...
                              <p
                                 ...
                                 Nos alegra mucho de tenerte aquí <strong>{{ $user->nombre }}</strong>.
                                 A continuación podrás acceder al panel de control para que
                                 puedas empezar a usar {{ env('APP_NAME') }}. Esperemos que te guste
                                       ...
                                       <td>
                                          <a
                                             ...
                                             target="_blank"><span>
                                                ...
                                                style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:7.5px">Vamos allá</span><span>
                                             </span></a>
                                       </td>
                                    </tr>
                                 </tbody>
